  ...
  forms: () => {
    (function () {
      ...
      window.addEventListener("load", function () {
        ...
        // reCAPTCHA callback funksiyalari
        ...
        // Har bir form uchun validatsiya
        Array.prototype.forEach.call(forms, function (form) {
          form.addEventListener("submit", function (event) {
            event.preventDefault(); // Formani odatiy yuborilishini bloklash
            event.stopPropagation();
  
            if (!form.checkValidity()) {
              // Forma validatsiyadan o‘tmagan bo‘lsa
            ...
            if (form.classList.contains("contact-form")) {
              // Faqat `contact-form` bo‘lsa, davom etadi
              var formData = new FormData(form);
              var messagesContainer = form.querySelector(".messages");
  
              fetch(form.action, {
                method: "POST",
                body: formData,
                headers: {
                  "X-Requested-With": "XMLHttpRequest", // AJAX so‘rov ekanligini aniqlash uchun
                },
              })
                .then((response) => {
                  if (!response.ok) {
                ...
                .then((data) => {
                  // Muvaffaqiyatli yoki xato xabarlarni ko‘rsatish
                  ...
                  if (data.success) {
                    // Muvaffaqiyatli bo‘lsa, formani tozalash
                    form.reset();
                    if (typeof grecaptcha !== "undefined") {
                      grecaptcha.reset(); // reCAPTCHA-ni qayta ishga tushirish
                    }
                  }
                })
                .catch((error) => {
                  ...
                  messagesContainer.innerHTML = errorBox;
                });
            }
          });
        });
